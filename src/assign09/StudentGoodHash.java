...
public class StudentGoodHash
{
    ...
    /**
     * a good primary hash function, returns a unique value for each student. Lowest incidence of
     * collisions.
     * @return a unique int to be clamped
     */
    public int hashCode() {
        int code = lastName.length() * 13;
        for(char l : firstName.toCharArray())
        {
            code *= (int) l * 13;
        }
        return (code * 23) + uid;
